...
<main class="main">
        ...
        <div class="container">
            ...
            <div class="content">
                <div class="title">
                    ...
                    <h2>Proč pořídit kolo značky TREK?</h2>
                ...
                <div class="all-content">
                    ...
                    <div class="img-gall">
                        ...
                        <img src="data/images/gall-3.jpg" alt="">
                        <img src="data/images/gall-4.jpg" alt="">
                        <img src="data/images/gall-5.jpg" alt="">
                        <img src="data/images/gall-6.jpg" alt="">
                    </div>
                    <h3>Pojďme si tedy nyní odpovědět na původní otázku. Proč vlastně pořídit kolo této značky?</h3>
                    ...
                    <h3>Opravdu tedy ještě váháte na jinou značkou?</h3>
                    <div class="btn-holder">
                        <a href="" class="btn full-dark"><span>Zobrazit kola od trek</span></a>
                        <a href="" class="btn full-dark"><span>Doplňky od trek</span></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="blog-posts">
        <div class="container">
            <h2 class="mark">Další články z blogu</h2>
            <div class="grid-block">
                <a href="" class="post">
                    <div class="img">
                        <img src="data/images/blog-prew-1.jpg" alt="">
                        <span class="date">16. 04. 2022</span>
                    </div>
                    <div class="text">
                        <h3>Jaký plášť na pořádny dirt</h3>
                        <p>Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                        <span class="arrow-button">Přečíst článek</span>
                    </div>
                </a>
                <a href="" class="post">
                    <div class="img">
                        <img src="data/images/blog-prew-2.jpg" alt="">
                        <span class="date">16. 04. 2022</span>
                    </div>
                    <div class="text">
                        <h3>Rozšiřujeme rodinu našich značek o CANOYON</h3>
                        <p>Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                        <span class="arrow-button">Přečíst článek</span>
                    </div>
                </a>
                <a href="" class="post">
                    <div class="img">
                        <img src="data/images/blog-prew-3.jpg" alt="">
                        <span class="date">16. 04. 2022</span>
                    </div>
                    <div class="text">
                        <h3>Oblečení pro ranní mrazíky a odpoleční výheň</h3>
                        <p>Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                        <span class="arrow-button">Přečíst článek</span>
                    </div>
                </a>
                <a href="" class="post">
                    <div class="img">
                        <img src="data/images/blog-prew-4.jpg" alt="">
                        <span class="date">16. 04. 2022</span>
                    </div>
                    <div class="text">
                        <h3>Lorem ipsum dolor sit amet adipscing lorem ipsum</h3>
                        <p>Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                        <span class="arrow-button">Přečíst článek</span>
                    </div>
                </a>
