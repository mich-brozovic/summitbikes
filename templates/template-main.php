...
<main class="main">
    <section class="main-swiper-section">
        <div class="swiper main-swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="swiper-holder">
                        <div class="text">
                            <h2 class="big">NOVÁ KOLA <br>
                                OD TREKU 2022</h2>
                            <p class="big">Připravily jsme 16 nových kol od firmy Trek </p>
                            <a href="" class="btn full-orange">
                                <span>zobrazit produkty</span>
                            </a>
                        </div>
                        <img src="data/images/swiper-main.jpg" alt="" />
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="swiper-holder">
    ...
    <section class="bikes-swiper">
        <div class="container">
            <h2 class="mark">Kola skladem</h2>
            ...
            <div class="swiper prod-swiper">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="swiper-holder">
                            <a href="" class="compare"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="swiper-holder">
                            <div class="helper">
                                ...
                                <div class="upper-text">
                                    ...
                                    <span class="old-cost">32 000 Kč</span>
                                </div>
                            </div>
                            <div class="lower-text">
                                <span class="stock in">Skladem</span>
                    ...
                    <div class="swiper-slide">
                        <div class="swiper-holder">
                            ...
                            <div class="lower-text">
                                <span class="stock out">Vyprodáno</span>
                                <span class="final-price">16 850 Kč</span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="swiper-holder">
                            <div class="helper">
                                <div class="img">
                                    <img src="data/images/bike-4.jpg" alt="">
                                    <!-- <div class="perks">
                                        <span class="perk new">Novinka</span>
                                        <span class="perk best">Bestseller</span>
                                        <span class="perk sale">-50%</span>
                            ...
                            <div class="lower-text">
                                <span class="stock inc">Očekáváme</span>
                                <span class="final-price">16 850 Kč</span>
                            </div>
                        </div>
                    </div>
