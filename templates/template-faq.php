...
<main class="main">
    ...
    <section class="faq">
        <div class="container">
            <h2 class="mark big">ČASTO KLADENÉ DOTAZY</h2>
            <div class="switchers-holder">
                <div class="faq-switcher active" id="nakup"><span>Nákup kola</span></div>
                <div class="faq-switcher" id="reklamace"><span>Reklamace</span></div>
                <div class="faq-switcher" id="udrzba"><span>Udržba kola</span></div>
                <div class="faq-switcher" id="doplnky"><span>Doplňky</span></div>
            </div>
            <div class="content-part active" data-target="nakup">
                <h3 class="big mark">NÁKUP KOLA</h3>
                <div class="flex-row faq-question">

                    <div class="title-block">
                        <h4>Dostanu kolo složené</h4>
                        <div class="arrow-block"></div>
                    </div>
                    <div class="content-block">
                        <p class="big">Značku fox vám asi nemusíme představovat, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        <ul>
                            <li>Lorem ipsum</li>
                            <li>Lorem ipsum</li>
                            <li>Lorem ipsum</li>
                        ...
                        <video src="data/videos/video-example.mp4" controls></video>
                        <p>Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                    </div>
                </div>
                <div class="flex-row faq-question">
                    ...
                    <div class="title-block">
                        <h4>Jak sestavit dodané kolo</h4>
                        <div class="arrow-block"></div>
                    </div>
                    <div class="content-block">
                        <p class="big">Značku fox vám asi nemusíme představovat, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                ...
                <div class="flex-row faq-question">
                    ...
                    <div class="title-block">
                        <h4>Jak často je potřeba kolo servisovat</h4>
                        <div class="arrow-block"></div>
                    </div>
                    <div class="content-block">
                        <p class="big">Značku fox vám asi nemusíme představovat, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                ...
                <div class="flex-row faq-question">
                    ...
                    <div class="title-block">
                        <h4>Lze obědnadné zboží vrátit</h4>
                        <div class="arrow-block"></div>
                    </div>
                    <div class="content-block">
                        <p class="big">Značku fox vám asi nemusíme představovat, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                ...
                <div class="flex-row faq-question">
                    ...
                    <div class="title-block">
                        <h4>Adpisicing lorem ipsum dolor sit amet</h4>
                        <div class="arrow-block"></div>
                    </div>
                    <div class="content-block">
                        <p class="big">Značku fox vám asi nemusíme představovat, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
            ...
            <div class="content-part" data-target="reklamace">
                <h3 class="big mark">Reklamace</h3>
                <div class="flex-row faq-question">
            ...
            <div class="content-part" data-target="udrzba">
                <h3 class="big mark">Udržba</h3>
                <div class="flex-row faq-question">
            ...
            <div class="content-part" data-target="doplnky">
                <h3 class="big mark">Doplnky</h3>
                <div class="flex-row faq-question">
                ...
                <form action="" class="custom-form">
                    <div class="wrapper">
                        <div class="form-row">
                            ...
                            <input type="text" placeholder="Pavel" name="firstName" id="firstName" required>
                        </div>
                        <div class="form-row">
                            <label for="lastName">Příjmení *</label>
                            <input type="text" placeholder="Novák" name="lastName" id="lastName" required>
                        </div>
                        <div class="form-row">
                            <label for="email">Email *</label>
                            <input type="email" placeholder="pavel.novak@seznam.cz" name="email" id="email" required>
                        </div>
                        <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <textarea name="dotaz" id="dotaz" cols="30" rows="10" required></textarea>
                    </div>
